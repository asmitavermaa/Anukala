...
function ShopPaintings() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#fff7ed] px-4 py-8"> 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6"> 
        {[{img: image12, title: 'Enlightened Serenity'}, {img: image2, title: 'Rainy Day Romance'}, {img: image3, title: 'Azure Blossoms'}, {img: image4, title: 'Poppy Paradise'}].map((product, index) => (
          <div 
            key={index}
            className="bg-orange-200 h-80 flex flex-col justify-center items-center cursor-pointer p-4 rounded-lg transition-transform transform hover:scale-105 shadow-md"
